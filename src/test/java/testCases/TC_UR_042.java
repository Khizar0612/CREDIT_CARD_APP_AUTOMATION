...
public class TC_UR_042 extends Base {
	...
	public void test() throws InterruptedException {
		...
		newPassword.sendKeys("Civic@1234");
		...
		cnfrmPassword.sendKeys("Civic@1234");
...
//      WebElement text = driver.findElement(By.xpath("//android.widget.TextView[@text="Your new password has been set successfully!"]"));
//      String actualText = text.getText();
//      String expectedText = "Your new password has been set successfully!";
