...
public class TC_UR_010 extends Base {
	...
	public void test() throws InterruptedException {
		...
		WebElement text = driver.findElement(By.xpath("//android.widget.TextView[contains(@text, 'Invalid Email')]"));
		String actualText = text.getText();
		String expectedText = "Invalid Email";
		Assert.assertEquals(actualText, expectedText);
		Thread.sleep(2000);

//		WebElement errorOKBtn = driver.findElement(By.xpath("//android.widget.TextView[@text=\"Ok\"]"));
//		errorOKBtn.click();
	}
}