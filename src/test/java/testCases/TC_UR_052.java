...
public class TC_UR_052 extends Base {
...
//      WebElement text = driver.findElement(By.xpath("//android.widget.TextView[@text="Password must be at least 8 characters long"]"));
//      String actualText = text.getText();
//      String expectedText = "Password must be at least 8 characters long";
